  ...
  return (
    <Form className="family-form" onSubmit={validateLogin}>
      ...
      <Form.Group className="mb-3" controlId="email">
        ...
        <Form.Control required autoComplete='email' type="email" name='email' placeholder="Email" onChange={onInputChange} value={familyInfo?.email} />
      </Form.Group>
      ...
      <Form.Group className="mb-3" controlId="phoneNumber">
        ...
        <Form.Control required autoComplete='tel' type="tel" name='phoneNumber' placeholder="Phone Number" onChange={onInputChange} value={familyInfo?.phoneNumber} />
      </Form.Group>
